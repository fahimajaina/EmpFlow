...
if (isset($_GET['id'])) {
    ...
    try {
        $sql = "SELECT p.*, e.EmpId, e.FirstName, e.LastName, e.EmailId, e.Phonenumber, e.Gender,
...
<head>
  ...
  <title>Payslip - <?php echo $payslip ? htmlspecialchars($payslip['FirstName'] . ' ' . $payslip['LastName']) : ''; ?></title>
...
<?php if ($error): ?>
  <div class="payslip-container">
    ...
    <div class="text-center">
      <a href="manage-payroll.php" class="btn-back">Back to Payroll</a>
    </div>
  </div>
<?php else: ?>
...
<div class="payslip-container">
  ...
  <div class="action-buttons">
    ...
    <a href="manage-payroll.php" class="btn-back">
