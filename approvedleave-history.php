...
<head>
  ...
  <title>EMPFLOW | Approved Leave History</title>
...
<div class="main-content" id="main-content">
  <div class="page-title">
    <span class="material-icons">event_note</span> Approved Leave History
  </div>
      ...
      <table class="table table-hover align-middle" id="leaveTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlentities(date('M d, Y', strtotime($leave['FromDate']))); ?></td>
            <td><?php echo htmlentities(date('M d, Y', strtotime($leave['ToDate']))); ?></td>
            <td><?php echo htmlentities(date('M d, Y H:i', strtotime($leave['PostingDate']))); ?></td>
          ...
          <tr>
            <td colspan="7" class="text-center text-muted py-4">  
              <p class="mt-2">No approved leave records found</p>
            </td>
          </tr>
          <?php } ?>
        </tbody>
